...
- [x] **Slice 8 — EmployeeList / EmployeeDetail / EmployeeForm** — committed `0d8f1c9` (with Slice 7)
  ...
  - [x] Commit — `0d8f1c9`
- [x] **Render deployment fix** (AI-014): `postinstall: prisma generate`, `prisma` in dependencies, `deploy` script (migrate then start), `render.yaml` blueprint for both services, README deployment section
